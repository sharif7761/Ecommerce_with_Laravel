			  ...
			  @csrf
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select id="selectError3"  data-rel="chosen" name="manufacture_id">
                        <option selected disabled hidden>Choose Manufacturer</option>
                ...
                <div class="control-group hidden-phone">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="number" class="input-xlarge" name="product_quantity" min="0">
                    </div>
                  </div>
				...
				<div class="form-actions">
				  ...
				  <a href="{{URL::to('/add-product')}}"><i class="btn">Cancel</i></a> 
				 </div>
			  </fieldset>
			</form>   
